...
describe("External Formatter", function () {
    ...
    var formatter;
    before(function () {
        var Formatter = lint_1.TestUtils.getFormatter(TEST_MODULE);
    ...
    it("formats failures", function () {
        ...
        var expectedResult = utils_1.dedent(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n            ", "", "\n            ", "", "\n            ", "", "\n"], ["\n            ", "", "\n            ", "", "\n            ", "", "\\n"])), getPositionString(1, 1), TEST_FILE, getPositionString(2, 11), TEST_FILE, getPositionString(9, 2), TEST_FILE).slice(1); // remove leading newline
    ...
    it("returns undefined for unresolvable module", function () {
        chai_1.assert.isUndefined(lint_1.TestUtils.getFormatter(TEST_FILE + "/__non-existent__"));
    });
...
//# sourceMappingURL=externalFormatterTests.js.map